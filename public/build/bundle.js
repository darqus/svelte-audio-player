    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(path, "class", "svelte-14pvrk0");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(path0, "class", "svelte-14pvrk0");
    			attr(path1, "d", paths.previousRight);
    			attr(path1, "class", "svelte-14pvrk0");
    			attr(svg0, "xmlns", XMLNS);
    			attr(svg0, "viewBox", viewBox);
    			attr(button0, "class", "svelte-14pvrk0");
    			attr(path2, "d", path2_d_value = /*isPlaying*/ ctx[1] ? paths.pauseLeft : paths.play);
    			attr(path2, "class", "svelte-14pvrk0");
    			attr(svg1, "xmlns", XMLNS);
    			attr(svg1, "viewBox", viewBox);
    			attr(button1, "class", "svelte-14pvrk0");
    			attr(path3, "d", paths.nextLeft);
    			attr(path3, "class", "svelte-14pvrk0");
    			attr(path4, "d", paths.nextRight);
    			attr(path4, "class", "svelte-14pvrk0");
    			attr(svg2, "xmlns", XMLNS);
    			attr(svg2, "viewBox", viewBox);
    			attr(button2, "class", "svelte-14pvrk0");
    			attr(path5, "d", paths.shuffle);
    			attr(path5, "class", "svelte-14pvrk0");
    			attr(svg3, "xmlns", XMLNS);
    			attr(svg3, "viewBox", viewBox);
    			attr(button3, "class", button3_class_value = "" + (null_to_empty(/*shuffle*/ ctx[3] ? '' : 'shuffle') + " svelte-14pvrk0"));
    			attr(path6, "d", paths.repeatLeft);
    			attr(path6, "class", "svelte-14pvrk0");
    			attr(path7, "d", paths.repeatRight);
    			attr(path7, "class", "svelte-14pvrk0");
    			attr(svg4, "xmlns", XMLNS);
    			attr(svg4, "viewBox", viewBox);
    			attr(button4, "class", button4_class_value = "" + (null_to_empty(/*repeat*/ ctx[4] ? '' : 'repeat') + " svelte-14pvrk0"));
    			attr(div0, "class", "buttons-control svelte-14pvrk0");
    			attr(strong, "class", "svelte-14pvrk0");
    			attr(marquee, "behavior", "scroll");
    			attr(marquee, "direction", "left");
    			attr(marquee, "scrollamount", "2");
    			attr(marquee, "class", "svelte-14pvrk0");
    			attr(div1, "class", "track-name svelte-14pvrk0");
    			attr(div2, "class", "current-time svelte-14pvrk0");
    			...
    			attr(div3, "class", "duration-time svelte-14pvrk0");
    			attr(div4, "class", "progress-control svelte-14pvrk0");

    			attr(path8, "d", path8_d_value = /*isMuted*/ ctx[2] || /*volume*/ ctx[7] == 0
    			? paths.muteSpeaker
    			: paths.volumeSpeaker);

    			attr(path8, "class", "svelte-14pvrk0");

    			attr(path9, "d", path9_d_value = /*isMuted*/ ctx[2] || /*volume*/ ctx[7] == 0
    			? paths.muteClose
    			: paths.volumeLeftLine);

    			attr(path9, "class", "svelte-14pvrk0");
    			attr(svg5, "xmlns", XMLNS);
    			attr(svg5, "viewBox", viewBox);
    			attr(button5, "class", "svelte-14pvrk0");
    			attr(input1, "type", "range");
    			attr(input1, "min", "0");
    			attr(input1, "max", "1");
    			attr(input1, "step", "0.01");
    			input1.value = /*volume*/ ctx[7];
    			attr(input1, "class", "svelte-14pvrk0");
    			attr(div5, "class", "volume-control svelte-14pvrk0");
    			attr(div6, "class", "track-ranges svelte-14pvrk0");
    			attr(div7, "class", "track-info svelte-14pvrk0");
    			attr(div8, "class", "audio-player svelte-14pvrk0");
    		},
    		m(target, anchor) {
