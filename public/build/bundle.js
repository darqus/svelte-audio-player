var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	let div4;
    	let span0;
    	let t8_value = formatTime(/*currentTime*/ ctx[1]) + "";
    	let t8;
    	let t9;
    	let span1;
    	let t10_value = formatTime(/*duration*/ ctx[2]) + "";
    	let t10;
    	let mounted;
    	let dispose;
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*currentTime, duration*/ 6) {
    				set_style(div2, "width", /*currentTime*/ ctx[1] / /*duration*/ ctx[2] * 100 + "%");
    			}

    			if (dirty & /*currentTime*/ 2 && t8_value !== (t8_value = formatTime(/*currentTime*/ ctx[1]) + "")) set_data(t8, t8_value);
    			if (dirty & /*duration*/ 4 && t10_value !== (t10_value = formatTime(/*duration*/ ctx[2]) + "")) set_data(t10, t10_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function updateTime() {
    		$$invalidate(1, currentTime = audio.currentTime);
    	}

    	function updateDuration() {
    		$$invalidate(2, duration = audio.duration);
    	}
